...
See the [Analyzer](/contributing/analyzer) page for detailed information about what gets extracted.
...
<CardGroup cols={2}>
  <Card title="Analyzer" icon="magnifying-glass" href="/contributing/analyzer">
